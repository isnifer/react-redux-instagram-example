...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Timeline = __webpack_require__(261);

	var _Timeline2 = _interopRequireDefault(_Timeline);

	var _SearchPhotos = __webpack_require__(270);

	var _SearchPhotos2 = _interopRequireDefault(_SearchPhotos);

	var _SearchUsers = __webpack_require__(271);
	...
	var _Followers = __webpack_require__(273);

	var _Followers2 = _interopRequireDefault(_Followers);

	var _PageNotFound = __webpack_require__(274);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouter.IndexRoute, { component: _Timeline2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'timeline', name: 'Timeline', component: _Timeline2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'photos', name: 'Photos', component: _SearchPhotos2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'users', name: 'People', component: _SearchUsers2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'profile/:id', name: 'Profile', component: _Profile2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'followed-by/:id', name: 'followed-by', component: _Followers2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'follows/:id', name: 'follows', component: _Followers2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: '*', name: 'not-found', component: _PageNotFound2.default })
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBasename2 = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timeline = __webpack_require__(252);

	var _profile = __webpack_require__(254);

	var _searchByUser = __webpack_require__(255);

	var _searchByTag = __webpack_require__(256);

	var _followers = __webpack_require__(257);

	var rootReducer = (0, _redux.combineReducers)({

	    // Timeline
	    timelineItems: _timeline.timelineItems,
	    timelinePagination: _timeline.timelinePagination,
	    timelineLoaded: _timeline.timelineLoaded,

	    // Profile
	    profile: _profile.profile,
	    counts: _profile.counts,
	    profileLoaded: _profile.profileLoaded,
	    profilePhotos: _profile.profilePhotos,
	    profilePagination: _profile.profilePagination,
	    profileError: _profile.profileError,

	    // Search by user
	    foundedUsers: _searchByUser.foundedUsers,

	    // Search by tag,
	    foundedPhotos: _searchByTag.foundedPhotos,
	    searchPagination: _searchByTag.searchPagination,
	    deniedTag: _searchByTag.deniedTag,

	    // Popular
	    popularPhotos: _searchByTag.popularPhotos,

	    // Followers
	    followers: _followers.followers,
	    followersPagination: _followers.followersPagination
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.timelineLoaded = exports.timelinePagination = exports.timelineItems = undefined;
	...
	var timelineItems = exports.timelineItems = function timelineItems() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.timelineItems : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.GET_TIMELINE_REQUEST:
	            return state;
	        case _constants.GET_TIMELINE_RESPONSE:
	        case _constants.UPDATE_TIMELINE_RESPONSE:
	...
	var timelinePagination = exports.timelinePagination = function timelinePagination() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.timelinePagination : arguments[0];
	    var action = arguments[1];
	...
	var timelineLoaded = exports.timelineLoaded = function timelineLoaded() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.timelineLoaded : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var GET_FOLLOWERS_REQUEST = exports.GET_FOLLOWERS_REQUEST = 'GET_FOLLOWERS_REQUEST';
	var GET_FOLLOWERS_RESPONSE = exports.GET_FOLLOWERS_RESPONSE = 'GET_FOLLOWERS_RESPONSE';
	var UPDATE_FOLLOWERS_REQUEST = exports.UPDATE_FOLLOWERS_REQUEST = 'UPDATE_FOLLOWERS_REQUEST';
	var UPDATE_FOLLOWERS_RESPONSE = exports.UPDATE_FOLLOWERS_RESPONSE = 'UPDATE_FOLLOWERS_RESPONSE';

	var GET_PROFILE_REQUEST = exports.GET_PROFILE_REQUEST = 'GET_PROFILE_REQUEST';
	var GET_PROFILE_RESPONSE = exports.GET_PROFILE_RESPONSE = 'GET_PROFILE_RESPONSE';
	var UPDATE_PROFILE_PHOTOS_REQUEST = exports.UPDATE_PROFILE_PHOTOS_REQUEST = 'UPDATE_PROFILE_PHOTOS_REQUEST';
	var UPDATE_PROFILE_PHOTOS_RESPONSE = exports.UPDATE_PROFILE_PHOTOS_RESPONSE = 'UPDATE_PROFILE_PHOTOS_RESPONSE';

	var GET_PROFILE_PHOTOS_REQUEST = exports.GET_PROFILE_PHOTOS_REQUEST = 'GET_PROFILE_PHOTOS_REQUEST';
	var GET_PROFILE_PHOTOS_RESPONSE = exports.GET_PROFILE_PHOTOS_RESPONSE = 'GET_PROFILE_PHOTOS_RESPONSE';

	var SEARCH_BY_TAG_REQUEST = exports.SEARCH_BY_TAG_REQUEST = 'SEARCH_BY_TAG_REQUEST';
	var SEARCH_BY_TAG_RESPONSE = exports.SEARCH_BY_TAG_RESPONSE = 'SEARCH_BY_TAG_RESPONSE';

	var GET_POPULAR_REQUEST = exports.GET_POPULAR_REQUEST = 'GET_POPULAR_REQUEST';
	var GET_POPULAR_RESPONSE = exports.GET_POPULAR_RESPONSE = 'GET_POPULAR_RESPONSE';

	var SEARCH_BY_USER_REQUEST = exports.SEARCH_BY_USER_REQUEST = 'SEARCH_BY_USER_REQUEST';
	var SEARCH_BY_USER_RESPONSE = exports.SEARCH_BY_USER_RESPONSE = 'SEARCH_BY_USER_RESPONSE';

	var GET_TIMELINE_REQUEST = exports.GET_TIMELINE_REQUEST = 'GET_TIMELINE_REQUEST';
	var GET_TIMELINE_RESPONSE = exports.GET_TIMELINE_RESPONSE = 'GET_TIMELINE_RESPONSE';
	var UPDATE_TIMELINE_RESPONSE = exports.UPDATE_TIMELINE_RESPONSE = 'UPDATE_TIMELINE_RESPONSE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.profileError = exports.profilePagination = exports.profilePhotos = exports.profileLoaded = exports.counts = exports.profile = undefined;
	...
	var profile = exports.profile = function profile() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.profile : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.GET_PROFILE_RESPONSE:
	            return action.payload.profile || {};
	        case _constants.GET_PROFILE_REQUEST:
	        default:
	            return state;
	    }
	};

	var counts = exports.counts = function counts() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.counts : arguments[0];
	    var action = arguments[1];
	...
	var profileLoaded = exports.profileLoaded = function profileLoaded() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.profileLoaded : arguments[0];
	    var action = arguments[1];
	...
	var profilePhotos = exports.profilePhotos = function profilePhotos() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.profilePhotos : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.UPDATE_PROFILE_PHOTOS_RESPONSE:
	            return state.concat(action.payload.profilePhotos);
	        case _constants.GET_PROFILE_PHOTOS_RESPONSE:
	            return action.payload.profilePhotos;
	        case _constants.GET_PROFILE_PHOTOS_REQUEST:
	...
	var profilePagination = exports.profilePagination = function profilePagination() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.profilePagination : arguments[0];
	    var action = arguments[1];
	...
	var profileError = exports.profileError = function profileError() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.profileError : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.foundedUsers = undefined;

	var _constants = __webpack_require__(253);

	var foundedUsers = exports.foundedUsers = function foundedUsers() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.SEARCH_BY_USER_RESPONSE:
	            return action.payload.foundedUsers;
	        case _constants.SEARCH_BY_USER_REQUEST:
	        default:
	            return state;
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deniedTag = exports.searchPagination = exports.foundedPhotos = undefined;
	...
	var foundedPhotos = exports.foundedPhotos = function foundedPhotos() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.foundedPhotos : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.SEARCH_BY_TAG_RESPONSE:
	        case _constants.GET_POPULAR_RESPONSE:
	        ...
	        case _constants.GET_POPULAR_REQUEST:
	        case _constants.SEARCH_BY_TAG_REQUEST:
	        default:
	            return state;
	    }
	};

	var searchPagination = exports.searchPagination = function searchPagination() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.searchPagination : arguments[0];
	    var action = arguments[1];
	...
	var deniedTag = exports.deniedTag = function deniedTag() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.deniedTag : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.followersPagination = exports.followers = undefined;

	var _constants = __webpack_require__(253);

	var followers = exports.followers = function followers() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _constants.GET_FOLLOWERS_REQUEST:
	        case _constants.GET_FOLLOWERS_RESPONSE:
	            return action.payload.followers;
	        case _constants.UPDATE_FOLLOWERS_RESPONSE:
	...
	var followersPagination = exports.followersPagination = function followersPagination() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App(_ref) {
	    ...
	    var links = routes[0].childRoutes.slice(0, 4).map(function (link, i) {
	        return _react2.default.createElement(
	            'li',
	            { className: 'menu__item', key: i },
	            _react2.default.createElement(
	                _reactRouter.Link,
	                {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'ul',
	                { className: 'menu g-clf' },
	                links
	            )
	        ),
	        _react2.default.createElement(
	            'div',
	            { className: 'main g-clf' },
	            children
	        ),
	        _react2.default.createElement(
	            'footer',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('a', { className: 'social__link icon-facebook', href: 'https://facebook.com/isnifee' })
	                ),
	                _react2.default.createElement(
	                    'li',
	                    { className: 'social__item' },
	                    _react2.default.createElement('a', { className: 'social__link icon-twitter', href: 'https://twitter.com/isnifer' })
	                ),
	                _react2.default.createElement(
	                    'li',
	                    { className: 'social__item' },
	                    _react2.default.createElement('a', { className: 'social__link icon-VK', href: 'https://vk.com/isnifer' })
	                ),
	                _react2.default.createElement(
	                    'li',
	                    { className: 'social__item' },
	                    _react2.default.createElement('a', { className: 'social__link icon-GitHub-circle', href: 'https://github.com/isnifer' })
	                )
	            ),
	            _react2.default.createElement(
	                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentsItem = function CommentsItem(_ref) {
	    var src = _ref.src;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: src, className: 'comments__pic' }),
	        _react2.default.createElement(
	            'a',
	            { className: 'comments__username', href: '#/profile/' },
	            author
	        ),
	        ': ',
	        _react2.default.createElement(
	...
	var TimelineUser = function TimelineUser(_ref2) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'user g-clf' },
	        _react2.default.createElement(
	            'a',
	            { href: '#/profile/' + userId, className: 'user__pic' },
	        ...
	        _react2.default.createElement(LikeHeart, { likes: likes, liked: liked })
	    );
	};

	var LikeHeart = function LikeHeart(_ref3) {
	    var liked = _ref3.liked;
	    var likes = _ref3.likes;

	    return _react2.default.createElement(
	        'span',
	        { className: 'user__likes' },
	        _react2.default.createElement('i', { className: liked ? 'user__like user__like_liked' : 'user__like' }),
	        _react2.default.createElement(
	            'span',
	            { className: 'user__likes-count' },
	            likes
	        )
	    );
	};

	var TimelinePhoto = function TimelinePhoto(_ref4) {
	    var id = _ref4.id;
	    var src = _ref4.src;
	...
	var TimelineVideo = function TimelineVideo(_ref5) {
	    var id = _ref5.id;
	    var src = _ref5.src;

	    return _react2.default.createElement(
	        'video',
	        { className: 'photo__pic', id: id, controls: true },
	        _react2.default.createElement('source', { src: src })
	    );
	};

	var TimelineItem = function TimelineItem(_ref6) {
	    var element = _ref6.element;
	    var id = _ref6.id;
	    var type = _ref6.type;
	    var user = _ref6.user;

	    var timelineElement = type === 'video' ? _react2.default.createElement(TimelineVideo, {
	        src: element.videos.standard_resolution.url,
	        id: id }) : _react2.default.createElement(TimelinePhoto, {
	        src: element.images.standard_resolution.url,
	        id: id, liked: element.user_has_liked });

	    var comments = element.comments.data.map(function (comment, i) {
	        return _react2.default.createElement(CommentsItem, {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(TimelineUser, {
	...
	var Timeline = function (_Component) {
	    ...
	    _createClass(Timeline, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch((0, _actions.getTimelineAction)({}));

	            (0, _helpers.loadOnScrollBottom)({
	                dispatch: dispatch,
	                action: _actions.updateTimelineAction,
	                that: this
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            var items = this.props.model.timelineItems.map(function (picture, i) {
	                return _react2.default.createElement(TimelineItem, {
	                    element: picture,
	                    user: picture.user,
	                    id: picture.id,
	                    type: picture.type,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchByUser = __webpack_require__(267);
	...
	var _searchByTag = __webpack_require__(268);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchPhotos = function (_Component) {
	    _inherits(SearchPhotos, _Component);

	    function SearchPhotos() {
	        _classCallCheck(this, SearchPhotos);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchPhotos).apply(this, arguments));
	    }

	    _createClass(SearchPhotos, [{
	        key: 'search',
	        value: function search(event) {
	            ...
	            dispatch((0, _actions.searchByTagAction)(this.refs.searchInput.value));
	        }
	    }, {
	        key: 'deniedTag',
	        value: function deniedTag() {
	            var _this2 = this;

	            this.refs.searchInput.style.border = '2px solid #f00';
	            setTimeout(function () {
	                _this2.refs.searchInput.style.border = 'none';
	            }, 2000);
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.props.dispatch((0, _actions.getPopularAction)());
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var _props$model = this.props.model;
	            var foundedPhotos = _props$model.foundedPhotos;
	            var deniedTag = _props$model.deniedTag;


	            var searchResultItems = foundedPhotos.map(function (photo, i) {
	                return _react2.default.createElement(
	                    'a',
	                    {
	                    ...
	                    _react2.default.createElement('img', { src: photo.images.standard_resolution.url })
	                );
	            });
	            ...
	            if (deniedTag) {
	                ...
	                searchResultItems = _react2.default.createElement(
	                    'div',
	                    null,
	                    'Don\'t try to search ',
	                    _react2.default.createElement(
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'form',
	                    { className: 'search__form', onSubmit: this.search.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchUsers = function (_Component) {
	    _inherits(SearchUsers, _Component);

	    function SearchUsers() {
	        _classCallCheck(this, SearchUsers);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchUsers).apply(this, arguments));
	    }

	    _createClass(SearchUsers, [{
	        key: 'search',
	        value: function search(event) {
	            event.preventDefault();
	            ...
	            dispatch((0, _actions.searchByUserAction)(this.refs.searchInput.value));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var searchResultItems = this.props.model.users.map(function (photo, i) {
	                return _react2.default.createElement(
	                    _reactRouter.Link,
	                    {
	                        to: 'profile/' + photo.id,
	                        ...
	                        key: i },
	                    _react2.default.createElement('img', { src: photo.profile_picture })
	                );
	            });
	...
	var Profile = function (_Component) {
	    ...
	    _createClass(Profile, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch((0, _actions.getProfileDataAction)({ userId: userId }));
	            dispatch((0, _actions.getProfilePhotosAction)({ userId: userId }));

	            (0, _helpers.loadOnScrollBottom)({
	                dispatch: dispatch,
	                action: _actions.updateProfilePhotosAction,
	                that: this,
	                userId: userId
	            });
	        }
	        ...
	        value: function render() {
	            var _props$model = this.props.model;
	            var profile = _props$model.profile;
	            var counts = _props$model.counts;
	            var photos = _props$model.photos;
	            var pagination = _props$model.pagination;
	            var error = _props$model.error;


	            if (error) {
	                return _react2.default.createElement(
	                    'div',
	                    { style: { fontSize: '20px', textTransform: 'uppercase', textAlign: 'center', margin: '50px 0' } },
	                    _react2.default.createElement(
	                        'strong',
	                        null,
	                        error
	            ...
	            var photoList = photos.map(function (photo, i) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'photo-list__item', key: i },
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'fancybox', href: photo.images.standard_resolution.url },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'span',
	                                { className: 'profile__media-digits' },
	                                counts.media
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _reactRouter.Link,
	                                { to: '/followed-by/' + this.props.params.id, className: 'profile__link_followers' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'profile__count' },
	                                    'Followers'
	                                ...
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'profile__followed_by-digits' },
	                                    counts.followed_by
	                                )
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _reactRouter.Link,
	                                { to: '/follows/' + this.props.params.id, className: 'profile__link_followers' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'profile__count profile__count_follow' },
	                                    'Follow'
	                                ),
	                                _react2.default.createElement('br', null),
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'profile__follows-digits' },
	                                    counts.follows
	                                )
	                            )
	                        )
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: profile.website, target: '_blank', className: 'profile__url' },
	                                profile.website
	                            )
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Followers = function (_Component) {
	    ...
	    function Followers() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Followers).apply(this, arguments));
	    }
	    ...
	    _createClass(Followers, [{
	        ...
	        value: function componentDidMount() {
	            var userId = this.props.params.id;
	            var type = this.props.route.name;

	            this.props.getFollowersAction({ userId: userId, type: type });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var followers = this.props.model.followers.map(function (follower, i) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'follow__item', key: follower.id },
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { to: 'profile/' + follower.id },
	                        _react2.default.createElement('img', { className: 'follow__avatar', src: follower.profile_picture }),
	                        _react2.default.createElement(
	                            'span',
	                            { className: 'follow__username' },
	                            '@',
	                            follower.username
	                        )
	                    )
	...
	}, { getFollowersAction: _actions.getFollowersAction, updateFollowersAction: _actions.updateFollowersAction })(Followers);
